...
public class SodiumExtraGameOptionPages {
    ...
    public static @NotNull OptionPage particle() {
        ...
        Map<String, List<Identifier>> otherParticles = ForgeRegistries.PARTICLE_TYPES.getKeys().stream().collect(Collectors.groupingBy(Identifier::getNamespace));
    ...
    private static @NotNull Text translatableName(@NotNull Identifier identifier, String category) {
    ...
    private static @NotNull Text translatableTooltip(@NotNull Identifier identifier, String category) {
