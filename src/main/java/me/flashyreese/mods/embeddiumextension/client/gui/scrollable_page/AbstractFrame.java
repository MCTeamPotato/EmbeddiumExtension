package me.flashyreese.mods.embeddiumextension.client.gui.scrollable_page;
...
public abstract class AbstractFrame extends AbstractWidget implements ParentElement {
    ...
    protected final List<AbstractWidget> children = new ObjectArrayList<>();
    protected final List<Drawable> drawable = new ObjectArrayList<>();
    protected final List<ControlElement<?>> controlElements = new ObjectArrayList<>();
    ...
    public void applyScissor(int x, int y, int width, int height, @NotNull Runnable action) {
